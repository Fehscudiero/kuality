...
export default function About() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Entregas rápidas com prazos e preços competitivos",
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
    },
    {
      title: "Atendimento Personalizado",
      desc: "Relação exclusiva com cada cliente desde o primeiro contato",
      icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.982-.023-1.965-.07-2.944M7 20H1v-2a3 3 0 015.356-1.857M7 20v-2c0-.982.023-1.965.07-2.944",
    },
    {
      title: "Qualidade Garantida",
      desc: "Produtos de alta performance com máxima eficiência",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-14 shadow-2xl border border-white">
            <div className="space-y-6 text-slate-600 text-lg md:text-xl leading-relaxed text-center sm:text-justify font-medium">
              <p>
                ...
                <span className="text-slate-900 font-bold">35 anos</span> no
                segmento, a Kuality se preocupa em oferecer produtos de
                qualidade com a máxima eficiência.
              </p>
              <p>
                ...
                <span className="text-cyan-600 font-semibold">ANVISA</span>.
              </p>
              <p>
                A Kuality tem por objetivo melhorar a cada dia, construindo
                assim uma relação exclusiva com nossos clientes, desde o
                atendimento, como também logística de entrega, prazos e preços.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, i) => (
            <div
              key={i}
              className="group bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-slate-100 transition-all duration-500 hover:-translate-y-2"
            >
