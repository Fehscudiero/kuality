      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <header className="mb-12 sm:mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-10 text-center md:text-left">
          <div className="max-w-2xl mx-auto md:mx-0">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-950 tracking-tighter uppercase italic leading-[1.2] md:leading-[0.9]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-10 xl:gap-16 items-center">
          ...
          <div className="lg:col-span-6 -mx-4 sm:-mx-6 md:mx-0 relative">
            ...
            <div
              ...
              className="bg-slate-950 border-[2px] md:border-[3px] border-blue-950 rounded-[2.5rem] md:rounded-[3rem] text-white relative shadow-[4px_6px_0_#172554] md:shadow-[6px_8px_0_#172554] h-[520px] sm:h-[600px] md:h-[620px] lg:h-[650px] xl:h-[680px] w-full flex flex-col overflow-hidden transition-all duration-500 z-30"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none" />

              <div className="lg:hidden absolute top-0 left-0 right-0 z-30 px-5 pt-4 pb-2 flex flex-col gap-2.5 bg-gradient-to-b from-slate-950 via-slate-950/90 to-transparent">
                <div className="flex justify-center">
                  <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-blue-950 animate-swipe-right">
                    <span className="text-[8px] font-black uppercase tracking-[0.2em] text-cyan-50">
              ...
              <div
                ref={contentRef}
                className="relative z-10 p-5 pt-20 sm:p-10 sm:pt-24 md:p-12 w-full flex-1 flex flex-col min-h-0 overflow-hidden justify-center"
              >
                <header className="flex-shrink-0 mb-3 sm:mb-8">
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 py-1 sm:px-3 sm:py-1 bg-cyan-500/10 rounded-full border border-cyan-500/20 mb-3 sm:mb-4">
                  ...
                  <h3 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase italic tracking-tighter leading-[0.9] mb-2 sm:mb-4 line-clamp-2 drop-shadow-md">
                    {selectedProduct.name}
                  </h3>
                  <p className="text-xs sm:text-base lg:text-lg text-slate-400 leading-snug sm:leading-relaxed font-medium italic border-l-[3px] sm:border-l-4 border-cyan-600 pl-3 sm:pl-4 md:pl-5 line-clamp-2 sm:line-clamp-3">
                    {selectedProduct.description}
                  </p>
                </header>

                <div className="flex-1 border-t border-blue-950/50 pt-3 sm:pt-6 flex flex-col justify-center">
                  <div className="grid grid-cols-2 gap-3 sm:gap-6 md:gap-8">
                    <div className="space-y-1.5 sm:space-y-4">
                      <h4 className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.4em] text-cyan-500 flex items-center gap-1.5 sm:gap-2">
                    ...
                    <div className="space-y-1.5 sm:space-y-4">
                      <h4 className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.4em] text-emerald-500 flex items-center gap-1.5 sm:gap-2">
                      ...
                      <div className="grid gap-1.5 sm:gap-2">
                        {selectedProduct.advantages.map((a, i) => (
                          <div
                            key={i}
                            className="p-1.5 sm:p-3 bg-white/5 rounded-md sm:rounded-lg border border-blue-950/50 flex items-center"
                          >
