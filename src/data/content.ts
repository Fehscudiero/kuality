export const companyInfo = {
  ...
  subheadline: 'Qualidade aliada a eficiência em produtos químicos. Com know how de mais de 35 anos no segmento.',
  phone: '(11) 98637-0023',
...
export const aboutText = {
  ...
  infrastructure: [
    {
      title: 'Laboratórios',
      description: 'Dois laboratórios: Controle de Qualidade e Desenvolvimento de novas tecnologias.'
    },
    {
      title: 'Estoque e Equipe',
      description: 'Programa de treinamento constante visando o aperfeiçoamento.'
    }
  ],
  licenses: [
...
export const products: Product[] = [
  {
    ...
    description: 'Fluido sintético 100% base vegetal. Não evapora, não oxida peças e protege metais sensíveis (amarelos).',
    features: [
      '100% base vegetal',
      'Não evapora',
      'Não oxida peças',
  ...
  },
  {
    ...
    description: 'Tecnologia Exclusiva. Ação desengraxante, decapante, apassivante e fosfatizante.',
    features: [
      'Desengraxante',
      'Decapante',
      'Apassivante',
  ...
  },
  {
    ...
    description: 'Ação em temperatura ambiente (sem aquecimento). Produto Alcalino.',
    features: [
  ...
  },
  {
    ...
    description: 'Estabilizador que reduz consumo, elimina fatores oxidantes e promove combustão completa.',
    features: [
      'Estabilizador',
      'Reduz consumo',
      'Elimina oxidantes',
  ...
  },
  {
    ...
    description: 'Solvente ecológico de alto poder. Livre de BTEX (Benzeno, Tolueno e Xileno).',
    features: [
      'Livre de BTEX',
      'Alto poder de solubilização',
      'Não tóxico'
    ],
    advantages: [
      'Odor agradável',
  ...
  },
  {
    ...
    description: 'Para decapagem, desoxidação de alumínio e desengraxe de vidros.',
    features: [
      'Decapagem',
      'Desoxidação de alumínio',
      'Desengraxe de vidros'
    ],
    advantages: [
      'Multi-superfícies',
      'Alta eficiência',
  ...
  },
  {
    ...
    description: 'Fosqueamento de vidros sem uso de produtos químicos perigosos.',
    features: [
      'Sem ácido fluorídrico',
      'Fosqueamento uniforme',
      'Seguro'
    ],
    advantages: [
...
export const qualityTests = {
  ...
  result: 'Sem geração de blister; sem migração ou infiltração no "CROSS CUT" (Aderência Aprovada)'
};
...
export const ctaMessage = "Não feche negócio antes de falar com a Kuality, com certeza você terá uma nova solução para sua empresa";